...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var code, tree, root, assignments, _i, assignments_1, a, right, subArgs, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    root = tree.rootNode;
                    assignments = root.descendantsOfType('assignment_expression');
                    for (_i = 0, assignments_1 = assignments; _i < assignments_1.length; _i++) {
                        ...
                        if (a.text === 'parent[x] = parent[parent[x]]') {
                            ...
                            subArgs = right.child(1);
                            console.log("Children of subscript_argument_list:");
                            for (i = 0; i < subArgs.childCount; i++) {
